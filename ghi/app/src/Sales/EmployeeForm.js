  ...
  return (
    <div className="row">
      <div className="offset-3 col-6">
        ...
        <h1 className="text-center my-4">Add a New Sales Person</h1>
            <form onSubmit={handleSubmit} id="create-hat-form">
                  ...
                  <div className="form-floating mb-3">
                    <input onChange={handleChangeEmployeeId} value= {employee_id} placeholder="Emplyee ID" required type="number" name="employee_id" id="employee_id" className="form-control" />
